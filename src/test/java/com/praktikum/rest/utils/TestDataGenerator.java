...
public class TestDataGenerator {
    ...
    /**
     * Generate simple user data dengan minimal fields
     * @return Map berisi minimal user data
     */
    public static Map<String, Object> generateSimpleUser() {
        Map<String, Object> userData = new HashMap<>();
    ...
    /**
     * Generate post data untuk blog/testing
     * @return Map berisi post data
     */
    public static Map<String, Object> generatePostData() {
        Map<String, Object> postData = new HashMap<>();
        postData.put("title", faker.lorem().sentence());
        postData.put("body", faker.lorem().paragraph());
        postData.put("userId", faker.number().numberBetween(1, 100));
        return postData;
    }
}