...
public class AuthenticationTests extends BaseTest {
    ...
    public void testWithMalformedData() {
        given()
                .contentType(ContentType.JSON)
                .body("{\"invalid\": \"data\"}") // Valid JSON data
                .when()
                .post("/posts") // POST request dengan data
                .then()
                .statusCode(201) // JSONPlaceholder masih accept data apapun
                .body("id", notNullValue()); // Validate generate ID
    }
    ...
    /**
     * Additional test untuk validate response time performance
     */
    @Test
    public void testResponseTime() {
        given()
                ...
                .then()
                .statusCode(200)
                .time(lessThan(3000L)); // Response time should be less than 3 seconds
    }
}