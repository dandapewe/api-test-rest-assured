...
public class UserAPITests extends BaseTest {
    ...
    public void testUpdateUser() {
        ...
        given()
                ...
                .contentType(ContentType.JSON) // Validate content type
                .body("name", equalTo("John Updated")) // Validate updated name
                .body("username", equalTo("johnupdated")) // Validate updated username
                .body("email", equalTo("john.updated@example.com")) // Validate updated email
